...
step.addEventListener('click',()=>{
    ...
    video.src = 'frontend/img/mcanvas-images/section-3/step.mp4';
})
smile.addEventListener('click',()=>{
    title.innerHTML="smile";
    video.src = 'frontend/img/mcanvas-images/section-3/smile.mp4';
})
charge.addEventListener('click',()=>{
    title.innerHTML="charge";
    video.src = 'frontend/img/mcanvas-images/section-3/Charger.mp4';
})
quiz.addEventListener('click',()=>{
    title.innerHTML="quiz";
    video.src = 'frontend/img/mcanvas-images/section-3/Quiz.mp4';
})
scratch.addEventListener('click',()=>{
    title.innerHTML="scratch";
    video.src = 'frontend/img/mcanvas-images/section-3/Scratch.mp4';
})
vr.addEventListener('click',()=>{
    title.innerHTML="vr";
    video.src = 'frontend/img/mcanvas-images/section-3/Vr.mp4';
})
sound.addEventListener('click',()=>{
    title.innerHTML="sound";
    video.src = 'frontend/img/mcanvas-images/section-3/Sound.mp4';
})
speech_round.addEventListener('click',()=>{
    title.innerHTML="voice";
    video.src = 'frontend/img/mcanvas-images/section-3/Voice.mp4';
})
game.addEventListener('click',()=>{
    title.innerHTML="game";
    video.src = 'frontend/img/mcanvas-images/section-3/Game.mp4';
})
tilt.addEventListener('click',()=>{
    title.innerHTML="tilt";
    video.src = 'frontend/img/mcanvas-images/section-3/Tilt.mp4';
})